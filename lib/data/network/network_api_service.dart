...
import 'package:mvvm_real/data/app_exception.dart';
import 'package:mvvm_real/data/network/base_api_service.dart';
import 'package:mvvm_real/shared/shared.dart';
...
class NetworkApiServices implements BaseApiServices {
  ...
  Future<dynamic> getApiResponse(String endpoint) async {
    try {
       final fullPath = Const.subUrl + endpoint;
      
      // Use Uri.parse to build the complete URL including query params
      final uri = Uri.parse('https://${Const.baseUrl}$fullPath');
